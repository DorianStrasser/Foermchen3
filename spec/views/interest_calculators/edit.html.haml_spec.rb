...
describe "interest_calculators/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit interest_calculator form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => interest_calculators_path(@interest_calculator), :method => "post" do
